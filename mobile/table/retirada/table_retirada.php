...
class RetiradaListar extends Ordenacao
{
    ...
    public function detalhe()
    {
        ...
        $sb->append("retirada_movimento.id_retirada,");
        ...
        $sb->append("LEFT JOIN retirada_movimento");
        $sb->append("ON retirada_movimento.id_frete = ocorrencia_movimento.id_movimento and ocorrencia_movimento.id_tipo_movimento = 14");
