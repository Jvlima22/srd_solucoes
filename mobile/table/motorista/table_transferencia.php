...
class TransferenciaListar extends Ordenacao
{
    ...
    private function dados($start, $length)
    {
        ...
        $sb->append("frete_documento.numero,");
    ...
    {
        $sb = new StringBuilder();
        $sb->append("ocorrencia_movimento.id_movimento = '{$_REQUEST['id_frete']}' and ocorrencia_movimento.id_tipo_movimento != 3 and ocorrencia_movimento.status != 10");
        return $sb->toString();
    }
    ...
    public function detalhe()
    {
        ...
        $sb->append("transferencia_movimento.id_transferencia,");
        ...
        $sb->append("LEFT JOIN transferencia_movimento");
        $sb->append("ON transferencia_movimento.id_frete = ocorrencia_movimento.id_movimento and ocorrencia_movimento.id_tipo_movimento = 15");
