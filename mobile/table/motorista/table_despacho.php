...
class DespachoListar extends Ordenacao
{
    ...
    public function detalhe()
    {
        ...
        $sb->append("minuta_movimento.id_minuta as id_despacho,");
        ...
        $sb->append("LEFT JOIN minuta_movimento");
        $sb->append("ON minuta_movimento.id_frete = ocorrencia_movimento.id_movimento and ocorrencia_movimento.id_tipo_movimento = 17");
