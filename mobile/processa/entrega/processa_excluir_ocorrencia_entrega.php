...
try {
	...
	status ='10',
	id_ocorrencia ='$id_ocorrencia'	WHERE id='$id_ocorrencia_movimento'";
    $sql->query($query_01);
...
'$dt_cadastro')";
	...
	WHERE ocorrencia_movimento.id_documento = '" . $id_documento . "' and (ocorrencia_movimento.id_tipo_movimento = 4 or ocorrencia_movimento.id_tipo_movimento = 13) and ocorrencia_movimento.id_movimento  = '{$id_frete}' and ocorrencia_movimento.status != 10  ORDER BY ocorrencia_movimento.id DESC LIMIT 1";
