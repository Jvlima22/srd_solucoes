...
'$dt_cadastro')";
	...
	(ocorrencia_movimento.id_tipo_movimento = '" . $id_tipo_movimento . "' or ocorrencia_movimento.id_tipo_movimento = 13) and 
	ocorrencia_movimento.id_movimento  = '{$id_frete}' and 
	ocorrencia_movimento.status != 10  ORDER BY ocorrencia_movimento.id DESC LIMIT 1";
    ...
    $url = SITE_URL . 'administrativo.php?link=4041&entrega=' . $id_manifesto;
	$sql->commit();
    if ($sql->hasErros()) {
