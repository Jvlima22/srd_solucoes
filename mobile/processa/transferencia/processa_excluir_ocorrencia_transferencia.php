...
try {
	...
	status ='10' WHERE id_ocorrencia='$id_ocorrencia' and id_movimento='$id_frete' and id_tipo_movimento=15 and id_motorista='$id_motorista'";
    $sql->query($query_01);
...
'$dt_cadastro')";
    ...
    WHERE  frete_documento.id_frete = '{$id_frete}' and transferencia_movimento.id_transferencia = '{$id_transferencia}' and transferencia.id_motorista = '{$id_motorista}'";
