...
try {
    ...
    if (empty($comprovante)) {
        throw new Exception('Erro campo comprovante_ocorrencia, acione o suporte.');
    }

    $query_01 = "UPDATE ocorrencia_movimento set 
	status ='10' WHERE id_ocorrencia='$id_ocorrencia' and id_motorista='$id_motorista' and id_movimento='$id_coleta' and id_tipo_movimento =3 ";
    $sql->query($query_01);
...
'$dt_cadastro')";
    ...
    $url = SITE_URL . 'administrativo.php?link=4060';
    $sql->commit();
    if ($sql->hasErros()) {
