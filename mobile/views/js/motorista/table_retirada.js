...
var tableRetirada = $("#table-retirada").DataTable({
    "ajax": {
        url: 'mobile/table/motorista/table_retirada.php',
        type: "POST",
        data: {
            action: 'listar',
            id: function () {
...
$("#retirada_excluir").on("shown.bs.modal", function (e) {
    ...
    $.ajax({
        url: 'mobile/table/motorista/table_retirada.php', type: "POST", dataType: "json", data: {
            ...
            $("#retirada_excluir").find('#comprovante').val(data.data.comprovante);
