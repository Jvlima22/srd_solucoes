...
var tableColeta = $("#table-coleta").DataTable({
    "ajax": {
        url: 'mobile/table/coleta/table_coleta.php',
        type: "POST",
        data: {
            action: 'listar',
            id: function () {
...
$("#coleta_excluir").on("shown.bs.modal", function (e) {
    ...
    $.ajax({
        url: 'mobile/table/coleta/table_coleta.php', type: "POST", dataType: "json", data: {
            ...
            $("#coleta_excluir").find('#id_motorista').val(data.data.id_motorista);
