...
<div class="modal fade" id="entrega" tabindex="-1" role="dialog"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="editar_modal" method="POST"
					  action="mobile/processa/motorista/processa_gravar_ocorrencia_entrega.php">
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12 text-left">
							...
							<select class="form-control ajustaIdSelect select-ocorrencia" required
								...
								WHERE ocorrencia.tipo = 4 and ocorrencia.motorista = 1 and ocorrencia.status = 1 ORDER BY ocorrencia.nome ASC";
					...
					<input type="text" id="id_documento" name="id_documento" value="">
