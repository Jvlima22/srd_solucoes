...
<div class="modal fade" id="lote_despacho" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="editar_modal" method="POST"
                  action="mobile/processa/motorista/processa_gravar_ocorrencia_lote_despacho.php">
                <div class="row">
                    <div class="col-md-12">
                        <label>Fretes:</label>
                ...
                <input type="hidden" id="id_tipo_movimento" name="id_tipo_movimento" value="17">
