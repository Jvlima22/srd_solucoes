...
<div class="modal fade" id="lote_retirada" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="editar_modal" method="POST"
                  action="mobile/processa/motorista/processa_gravar_ocorrencia_lote_retirada.php">
                <div class="row">
                    <div class="col-md-12">
                        <label>Fretes:</label>
                    ...
                    <div class="col-md-12 text-left">
                        ...
                        <select class="form-control ajustaIdSelect select-ocorrencia" required
                            ...
                            $pesquisar_ocorrencia = "SELECT 
								...
								WHERE ocorrencia.tipo = 14 and ocorrencia.motorista = 1 and ocorrencia.status = 1 ORDER BY ocorrencia.nome ASC";
                ...
                <input type="hidden" id="id_tipo_movimento" name="id_tipo_movimento" value="14">
