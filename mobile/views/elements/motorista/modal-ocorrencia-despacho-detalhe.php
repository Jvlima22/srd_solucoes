...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <br>
        <input type="hidden" id="id_frete_minuta" name="id_frete" value="">
        <input type="hidden" id="id_manifesto" name="id_manifesto" value="">
        <input type="hidden" id="id_despacho" name="id_minuta" value="">
        <input type="hidden" id="id_tipo_movimento" name="id_tipo_movimento" value="">
        <input type="hidden" id="id_despacho_detalhe" name="id_despacho" value="">
