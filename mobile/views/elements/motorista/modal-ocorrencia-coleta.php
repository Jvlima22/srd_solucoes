...
<div class="modal fade" id="coleta" tabindex="-1" role="dialog"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="editar_modal" method="POST"
					  action="mobile/processa/motorista/processa_gravar_ocorrencia_coleta.php">
					<div class="row">
						<div class="col-md-6">
							<label>Coleta:</label>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-left">
                            ...
                            <select class="form-control ajustaIdSelect select-ocorrencia" required
								...
								WHERE ocorrencia.tipo = 3 and ocorrencia.motorista = 1 and ocorrencia.status = 1 ORDER BY ocorrencia.nome ASC";
					...
					<input type="hidden" id="id_coleta" name="id_coleta" value="">
