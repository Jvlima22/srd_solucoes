...
<div class="modal fade" id="retirada" tabindex="-1" role="dialog"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="editar_modal" method="POST"
					  action="mobile/processa/retirada/processa_gravar_ocorrencia_retirada.php">
					<div class="row">
						<div class="col-md-6">
                    ...
                    <br>
					<input type="text" id="id_frete" name="id_frete" value="">
                    <input type="text" id="id_manifesto" name="id_manifesto" value="">
                    <input type="text" id="id_motorista" name="id_motorista" value="">
					<input type="text" id="id_retirada" name="id_retirada" value="">
					<input type="text" name="id_tipo_movimento" value="14">
