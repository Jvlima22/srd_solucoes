...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <br>
        <input type="hidden" id="id_frete_retirada" name="id_frete" value="">
        <input type="hidden" id="id_manifesto" name="id_manifesto" value="">
        <input type="hidden" id="id_retirada" name="id_minuta" value="">
        <input type="hidden" id="id_tipo_movimento" name="id_tipo_movimento" value="">
        <input type="hidden" id="id_retirada_detalhe" name="id_retirada" value="">
