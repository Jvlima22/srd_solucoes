...
<div class="modal fade" id="despacho_excluir" tabindex="-1" role="dialog"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="excluir_modal" method="POST"
					  action="mobile/processa/despacho/processa_excluir_ocorrencia_despacho.php">
					<div class="row">
						<div class="col-md-2">
							<label>Nº:</label>
					...
					<input type="text" id="id_despacho" name="id_despacho" value="">
