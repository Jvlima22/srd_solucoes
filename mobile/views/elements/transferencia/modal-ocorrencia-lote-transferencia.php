...
<div class="modal fade" id="lote_transferencia" tabindex="-1" role="dialog"
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title text-center" id="myModalLabel">Lançar Ocorrênciaaaa</h4>
        </div>
        <div class="modal-body">
            <form class="editar_modal" method="POST"
                  action="mobile/processa/transferencia/processa_gravar_ocorrencia_lote_transferencia.php">
                <div class="row">
                    <div class="col-md-12">
                        <label>Fretes:</label>
                    ...
                    <div class="col-md-12 text-left">
                        ...
                        <select class="form-control ajustaIdSelect select-ocorrencia" required
                            ...
                            $pesquisar_ocorrencia = "SELECT 
								...
								WHERE ocorrencia.tipo = 15 and ocorrencia.motorista = 1 and ocorrencia.status = 1 ORDER BY ocorrencia.nome ASC";
                ...
                <input type="hidden" id="id_tipo_movimento" name="id_tipo_movimento" value="15">
                <input type="hidden" id="id_frete" name="id_frete" value="">
                <div class="modal-footer">
                    <button type="submit" class="btn btn-large btn-cor_02 btnEditar">SALVAR</button>
                    <button type="button" class="btn btn-cor_03"
